  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-10 flex flex-col items-center gap-6">
        ...
        <motion.nav {...reveal(0.08)} className="flex flex-wrap justify-center gap-x-8 gap-y-3">
          {[
        ...
        <motion.div {...reveal(0.16)} className="flex items-center gap-4">
          <motion.a
            href="https://www.instagram.com/studio.sibley23/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Instagram"
            whileHover={{ scale: 1.2, color: "var(--color-coral)" }}
