...
}: { src: string; width: number; height: number; alt: string; zoomEnabled: boolean }) {
    ...
    >
      ...
      >
        <Image
          ...
          priority
          draggable={false}
          style={{ maxWidth: "100%", maxHeight: "100%", width: "auto", height: "auto", display: "block", pointerEvents: "none", userSelect: "none" }}
        />
      </div>
    </div>
  );
