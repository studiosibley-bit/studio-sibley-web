...
export default async function AboutPage() {
  ...
  return (
    <AboutClient
      bgUrl={bgUrl}
      storyText={settings?.aboutStoryText}
      timelineStep1={settings?.aboutTimelineStep1}
      timelineStep2={settings?.aboutTimelineStep2}
      timelineStep3={settings?.aboutTimelineStep3}
